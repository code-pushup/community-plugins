...
type RunnerOptions = FileSizePluginConfig;
...
export const fileSizeCategoryRefs: CategoryRef[] = Object.values(auditsMap).map(
  ({ slug }) => ({
    type: 'audit',
    plugin: pluginSlug,
    slug,
...
export const fileSizeCategories: CategoryConfig[] = [
  {
    slug: 'file-size',
    title: 'File Size',
    description: 'File size checks',
    refs: [...fileSizeCategoryRefs],
  },
];
